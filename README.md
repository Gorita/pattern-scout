...
[nibzard/awesome-agentic-patterns](https://github.com/nibzard/awesome-agentic-patterns)의 한국어 번역 웹사이트입니다. 실전 프로덕션 환경에서 AI 에이전트를 구축하는 데 필요한 **117개의 에이전트 AI 패턴**을 한국어와 영어로 제공합니다.
