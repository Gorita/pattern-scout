...
**Pattern Scout** is a web application that helps you quickly find the right design patterns when building AI agents. It provides **167 patterns** from [nibzard/awesome-agentic-patterns](https://github.com/nibzard/awesome-agentic-patterns) in both Korean and English, with category-based navigation and real-time search.
...
- 📂 **Category Organization** - 8 major categories, 167 patterns
...
- 🎛️ **Orchestration & Control** (50) - Task decomposition, sub-agent spawning
...
- ✅ **Reliability & Eval** (21) - Guardrails, evaluation framework
- 🔒 **Security & Safety** (14) - Isolated VM, PII tokenization
- 🔧 **Tool Use & Environment** (25) - Shell, browser, DB
