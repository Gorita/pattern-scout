...
**Pattern Scout** is a web application that helps you quickly find the right design patterns when building AI agents. It provides **150 patterns** from [nibzard/awesome-agentic-patterns](https://github.com/nibzard/awesome-agentic-patterns) in both Korean and English, with category-based navigation and real-time search.
...
- 📂 **Category Organization** - 8 major categories, 150 patterns
...
- 🎛️ **Orchestration & Control** (45) - Task decomposition, sub-agent spawning
...
- 🔒 **Security & Safety** (9) - Isolated VM, PII tokenization
